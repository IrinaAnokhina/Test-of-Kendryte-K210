...
void i2c_master_init(void)
{
    ...
    gpiohs_set_pin(11, GPIO_PV_HIGH);
...
uint8_t i2c_send_byte(uint8_t data)
{
    ...
    gpiohs_set_drive_mode(10, GPIO_DM_INPUT);
    usleep(DELAY_TIME);
    gpiohs_set_pin(11, GPIO_PV_HIGH);
    data = gpiohs_get_pin(10);
    usleep(DELAY_TIME);
    gpiohs_set_pin(11, GPIO_PV_LOW);
